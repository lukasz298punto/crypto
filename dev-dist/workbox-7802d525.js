    ...
    */
    ...
    function cacheDonePromiseForTransaction(tx) {
        ...
        const done = new Promise((resolve, reject) => {
            ...
            const error = () => {
                reject(
                    tx.error || new DOMException('AbortError', 'AbortError')
                );
                unlisten();
            };
    ...
    function getMethod(target, prop) {
        ...
        if (
            ...
            !(
                targetFuncName in
                (useIndex ? IDBIndex : IDBObjectStore).prototype
            ) ||
